...
command += "&& scp " + plugin + "-api/target/" + plugin + "-plugin-api-4.0.0-RC8-SNAPSHOT.jar " + plugin + "-cli/target/" + plugin + "-plugin-cli-4.0.0-RC8-SNAPSHOT.jar " + plugin + "-impl/target/" + plugin + "-plugin-impl-4.0.0-RC8-SNAPSHOT.jar " + plugin + "-rest/target/" + plugin + "-plugin-rest-4.0.0-RC8-SNAPSHOT.jar "
